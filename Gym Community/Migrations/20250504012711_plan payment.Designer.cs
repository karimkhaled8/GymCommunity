...
namespace Gym_Community.Migrations
{
    ...
    [Migration("20250504012711_plan payment")]
    partial class planpayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gym_Community.Domain.Models.Gym.GymPlan", b =>
                {
                    ...
                    b.Property<bool>("HasAccessToAllAreas")
                        .HasColumnType("bit");

                    b.Property<bool>("HasNutritionPlan")
                        .HasColumnType("bit");

                    b.Property<bool>("HasPrivateCoach")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Gym_Community.Domain.Models.Notify.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Gym_Community.Domain.Data.Models.Meals_and_Exercise.DailyPlan", b =>
                {
                    b.HasOne("Gym_Community.Domain.Models.Coach_Plans.WeekPlan", null)
            ...
            modelBuilder.Entity("Gym_Community.Domain.Data.Models.Payment_and_Shipping.Shipping", b =>
                {
                    b.HasOne("Gym_Community.Domain.Data.Models.E_comm.Order", "Order")
                        .WithOne("Shipping")
                        .HasForeignKey("Gym_Community.Domain.Data.Models.Payment_and_Shipping.Shipping", "OrderID");
            ...
            modelBuilder.Entity("Gym_Community.Domain.Models.Coach_Plans.WeekPlan", b =>
                {
                    b.HasOne("Gym_Community.Domain.Data.Models.Meals_and_Exercise.TrainingPlan", null)
                        .WithMany("WeekPlans")
            ...
            modelBuilder.Entity("Gym_Community.Domain.Models.Gym.Gym", b =>
                {
                    b.HasOne("Gym_Community.Domain.Models.AppUser", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Gym_Community.Domain.Models.Gym.GymCoach", b =>
                {
                    ...
                    b.HasOne("Gym_Community.Domain.Models.Gym.Gym", "Gym")
                        .WithMany("Coaches")
                        .HasForeignKey("GymId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Gym_Community.Domain.Models.Gym.UserSubscription", b =>
                {
                    ...
                    b.HasOne("Gym_Community.Domain.Models.Gym.GymPlan", "Plan")
                        .WithMany("UserSubscriptions")
