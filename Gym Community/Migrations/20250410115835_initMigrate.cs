        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StripeChargeId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkoutAvailability = table.Column<int>(type: "int", nullable: false),
                    Client = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    clientGoal = table.Column<int>(type: "int", nullable: false),
                    OtherGoal = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientInfo_AspNetUsers_Client",
                        column: x => x.Client,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                name: "CoachPortfolios",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CoachId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AboutMeImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AboutMeDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Qualifications = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExperienceYears = table.Column<int>(type: "int", nullable: false),
                    SkillsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SocialMediaLinksJson = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoachPortfolios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoachPortfolios_AspNetUsers_CoachId",
                        column: x => x.CoachId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayNumber = table.Column<int>(type: "int", nullable: false),
                    DailyPlanJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StaticPlanId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProtofolioId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoachCertificates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoachCertificates_CoachPortfolios_ProtofolioId",
                        column: x => x.ProtofolioId,
                        principalTable: "CoachPortfolios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkSamples_CoachPortfolios_ProtofolioId",
                        column: x => x.ProtofolioId,
                        principalTable: "CoachPortfolios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipingId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingStatus = table.Column<int>(type: "int", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoachCertificates_ProtofolioId",
                table: "CoachCertificates",
                column: "ProtofolioId");

            migrationBuilder.CreateIndex(
                name: "IX_CoachPortfolios_CoachId",
                table: "CoachPortfolios",
                column: "CoachId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkSamples_ProtofolioId",
                table: "WorkSamples",
                column: "ProtofolioId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Orders_Shippings_ShipingId",
                table: "Orders",
                column: "ShipingId",
